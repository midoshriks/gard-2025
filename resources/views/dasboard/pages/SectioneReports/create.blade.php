    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">{{ display('Create') }}{{ display('Section') }} {{ display('Repot') }}</h4>
            ...
            {{-- modal-body --}}
            <form action="{{ route('dashboard.sections_repots.store') }}" method="post">
                @csrf
                @method('POST')
                    ...
                    <div class="form-row mb-2">
                        <div class="col">
                            <input class="form-control form-control-lg mb-2" name="name" type="text"
                                placeholder="{{ display('Enter name Section') }}">
                        </div>
