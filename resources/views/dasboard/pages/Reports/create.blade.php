            ...
            <div class="form-row mb-2">
                ...
                <div class="col">
                    <input class="form-control form-control-lg mb-2" name="name" type="text"
                        placeholder="{{ display('Enter name Report') }}">
                </div>
            </div>
            ...
            <div class="form-row mb-2">
                <div class="col">
                    <input class="form-control form-control-lg mb-2" name="title" type="text"
                        placeholder="{{ display('Enter name title') }}">
                </div>

                <div class="col">
                    <input class="form-control form-control-lg mb-2" name="branch" type="text"
                        placeholder="{{ display('Enter name branch') }}">
                </div>
            </div>

            <div class="mb-3">
                <textarea class="textarea" name="body" placeholder="Place some text here" rows="30"
                    style="width: 100%; height: 27px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
            </div>
        </div>
