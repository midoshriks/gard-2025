        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    @include('dasboard.pages.Jobs.create')
                            ...
                            @foreach ($jobs as $key => $job)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {{-- ----------------------------   ---  --------------------------- --}}
                                        <a href="{{ route('dashboard.jobs.destroy', $job->id) }}" class="btn btn-danger"
