    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">{{ display('Create setting pdf') }}</h4>
            ...
            {{-- modal-body --}}
            <form action="{{ route('dashboard.setting_pdf.store') }}" method="post">
                @csrf
                @method('POST')
