...
use App\Http\Requests\StoreCashierPostRequest;
use App\Http\Requests\UpdateCashierPostRequest;
...
class CashierPostController extends Controller
{
     ...
     */
    public function store(StoreCashierPostRequest $request)
    {
        // dd($request->all());
        $request->validate([
            'date' => 'required|date',
     ...
     */
    public function edit(CashierPost $cashierPost)
    {
        // dd($cashierPost);
        $cashierpost = CashierPost::findOrFail($cashierPost->id);
     ...
     */
    public function update(UpdateCashierPostRequest $request, CashierPost $cashierPost)
    {
        //
    }
